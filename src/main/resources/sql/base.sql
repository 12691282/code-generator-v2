...
CREATE TABLE `generator_table_info`  (
  ...
  `class_name` varchar(50)  COMMENT '实体类名称',
  `data_base_suffix` varchar(50)  COMMENT '数据库类后缀',
  `prototype_class_suffix` varchar(50)  COMMENT '原型类后缀',
...
CREATE TABLE `generator_table_column`  (
  ...
  `is_date` char(1)  COMMENT '是否日期字段（1是）',
...
CREATE TABLE `generator_config_info`  (
  ...
  `base_model_name` varchar(50)  COMMENT '模块名',
  `data_base_suffix` varchar(10)  COMMENT '数据库类后缀',
  `prototype_class_suffix` varchar(10)  COMMENT '原型类后缀',
